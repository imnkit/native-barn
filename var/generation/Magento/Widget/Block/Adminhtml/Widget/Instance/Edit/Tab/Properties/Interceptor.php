...
class Interceptor extends \Magento\Widget\Block\Adminhtml\Widget\Instance\Edit\Tab\Properties implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getWidgetInstance()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getWidgetInstance', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getMainFieldset()
    {
        ...
        if (!$pluginInfo) {
            return parent::getMainFieldset();
        } else {
            return $this->___callPlugins('getMainFieldset', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addFields()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('addFields', func_get_args(), $pluginInfo);
        }
    }
