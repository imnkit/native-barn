...
class Interceptor extends \Magento\Framework\Config\View implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDomConfigCopy');
        if (!$pluginInfo) {
            return parent::getDomConfigCopy();
        } else {
            return $this->___callPlugins('getDomConfigCopy', func_get_args(), $pluginInfo);
        }
    }
