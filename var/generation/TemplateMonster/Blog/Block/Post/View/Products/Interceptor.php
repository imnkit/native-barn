...
class Interceptor extends \TemplateMonster\Blog\Block\Post\View\Products implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRelatedProductsNumberPerView');
        if (!$pluginInfo) {
            return parent::getRelatedProductsNumberPerView();
        } else {
            return $this->___callPlugins('getRelatedProductsNumberPerView', func_get_args(), $pluginInfo);
        }
    }
