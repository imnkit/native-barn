...
class Interceptor extends \TemplateMonster\FeaturedProduct\Block\FeaturedProduct\Widget\Product implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemWidth');
        if (!$pluginInfo) {
            return parent::getItemWidth();
        } else {
            return $this->___callPlugins('getItemWidth', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTextData');
        if (!$pluginInfo) {
            return parent::getTextData();
        } else {
            return $this->___callPlugins('getTextData', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'truncateProductName');
        if (!$pluginInfo) {
            return parent::truncateProductName($name);
        } else {
            return $this->___callPlugins('truncateProductName', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCategoryNames');
        if (!$pluginInfo) {
            return parent::getCategoryNames();
        } else {
            return $this->___callPlugins('getCategoryNames', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isCategoryPrimaryTabs');
        if (!$pluginInfo) {
            return parent::isCategoryPrimaryTabs();
        } else {
            return $this->___callPlugins('isCategoryPrimaryTabs', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isProductTypePrimaryTabs');
        if (!$pluginInfo) {
            return parent::isProductTypePrimaryTabs();
        } else {
            return $this->___callPlugins('isProductTypePrimaryTabs', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductsLabel');
        if (!$pluginInfo) {
            return parent::getProductsLabel($product, $label);
        } else {
            return $this->___callPlugins('getProductsLabel', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'replaceString');
        if (!$pluginInfo) {
            return parent::replaceString($product, $string);
        } else {
            return $this->___callPlugins('replaceString', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSavePercent');
        if (!$pluginInfo) {
            return parent::getSavePercent($product);
        } else {
            return $this->___callPlugins('getSavePercent', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSaveAmount');
        if (!$pluginInfo) {
            return parent::getSaveAmount($product);
        } else {
            return $this->___callPlugins('getSaveAmount', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getFormatedPrice($product)
    {
        ...
        if (!$pluginInfo) {
            return parent::getFormatedPrice($product);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getNewFor');
        if (!$pluginInfo) {
            return parent::getNewFor($product);
        } else {
            return $this->___callPlugins('getNewFor', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'attrCode');
        if (!$pluginInfo) {
            return parent::attrCode($product, $string);
        } else {
            return $this->___callPlugins('attrCode', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'breakString');
        if (!$pluginInfo) {
            return parent::breakString($string);
        } else {
            return $this->___callPlugins('breakString', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'filterContent');
        if (!$pluginInfo) {
            return parent::filterContent($data);
        } else {
            return $this->___callPlugins('filterContent', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getGalleryDataJson');
        if (!$pluginInfo) {
            return parent::getGalleryDataJson($product);
        } else {
            return $this->___callPlugins('getGalleryDataJson', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getVideoSettings');
        if (!$pluginInfo) {
            return parent::getVideoSettings();
        } else {
            return $this->___callPlugins('getVideoSettings', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function isMainImage($product, $image)
    {
        ...
        if (!$pluginInfo) {
            return parent::isMainImage($product, $image);
        } else {
